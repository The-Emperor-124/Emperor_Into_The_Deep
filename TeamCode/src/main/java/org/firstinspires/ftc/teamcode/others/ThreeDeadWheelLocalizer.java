...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1987.9090729199017; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2177.91501319932; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -544.4868255881422; // x position of the perpendicular encoder (in tick units)
    }
